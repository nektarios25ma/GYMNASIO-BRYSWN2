...
//ΕΠΙΣΗΣ ΕΓΙΝΕ ΠΡΟΣΘΗΚΗ ΣΤΟ ΠΡΟΓΡΑΜΜΑ ARDUINO ΤΗΣ ΜΠΑΡΑΣ ΤΟΥ ΝΟΣΟΚΟΜΕΙΟΥ ΘΕΡΜΟΚΡΑΣΙΑΣ ΚΑΙ ΦΩΝΗΤΙΚΗΣ(SOFTWARE) ΠΡΟΕΙΔΟΠΟΙΗΣΗΣ ΣΕ ΠΕΡΙΠΤΩΣΗ ΧΑΜΗΛΗΣ Ή ΥΨΗΛΗΣ ΘΕΡΜΟΚΡΑΣΙΑΣ ΜΕ ΟΔΗΓΙΕΣ
// I2C LCD screen demo
